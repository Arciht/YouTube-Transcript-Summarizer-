...
with st.sidebar:
    ...
    api_key = st.text_input("OpenAI API Key", type="password", placeholder="AQ...")
    st.markdown("Get your key at [Google AI Studio](https://aistudio.google.com/api-keys?project=fleet-anagram-471707-s2)")
